...
function Activities() {
  ...
  const [isDetailsActivityModalOpen, setIsDetailsActivityModalOpen] =
  ...
  useEffect(() => {
    ...
    const handleOpenDetailsActivityModal = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <ActivityDetailsModal
        isOpen={isDetailsActivityModalOpen}
        onClose={() => setIsDetailsActivityModalOpen(false)}
